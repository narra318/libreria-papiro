            ...
            <div class=" col-md-12 p-5 justify-content-center">
                ...
                <form action="../../codigo/inventario/tematica.php" method="POST">
                    <div class="form-floating m-4 mx-auto" style="width: 50%;">
                        <input type="text" placeholder="Ingrese el nombre del producto"  minlength="3" pattern="^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+(?:[ \t][a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+)*$"  name="nueva-tematica" id="nueva-tematica" class="form-control bg-dark bg-opacity-75 text-light border-bottom border-light " required>
